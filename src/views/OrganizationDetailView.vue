...
import { formatCustomerPhoneNumber, handleUpdateFavoriteDetail } from '@/common/commonFunction'
...
<template>
  <div class="OrganizationDetailView">
    <Header
      :back="dataPost?.type === 'GOVERNMENT' ? '/government-list' : '/finance-list'"
      :icon="2"
      :title="dataPost?.type === 'GOVERNMENT' ? '지원기관' : '금융기관'"
      :iconRight="2"
    ></Header>
    ...
    <div
      v-else
      class="OrganizationDetailView__content wrapper__main mt0px"
      style="max-height: calc(100vh - 60px)"
      @scroll="scrolling"
    >
      <div class=" " ref="someElementTop"></div>

      <div class="OrganizationDetailView__mid">
        <div class="OrganizationDetailView__mid__item">
...
.OrganizationDetailView {
  ...
  .OrganizationDetailView__content {
    .OrganizationDetailView__mid {
      padding: 20px 16px;
      background-color: #f1f2f6;
      .OrganizationDetailView__mid__item {
        width: 328px;
        height: 201px;
